...
<div class="form-container">
    <form method="POST" action="<?php echo Helper::url('admin/collections/create'); ?>" class="admin-form"
        enctype="multipart/form-data">
        <div class="form-group">
            <label>Title (Optional)</label>
            <input type="text" name="title" placeholder="Premium Men Watches">
        </div>
        ...
        <div class="form-group">
            ...
            <div class="image-upload-options">
                ...
                <div id="url-tab" class="upload-tab-content active">
                    <input type="text" name="image" id="image_url" placeholder="https://images.unsplash.com/photo-..."
                        required>
